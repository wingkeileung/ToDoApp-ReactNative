		...
		<View style = { styles.container } >
			<Image style = { styles.imageBackground } source = { image } >
				<View style = { styles.header } >
					<TextInput style = {{ height: 40, borderColor: 'gray', borderWidth: 1, width: '70%', marginTop: 50, marginRight: '20%' }}
			...
			<Text style = {
					{ color: 'white' }
			} > Simple to do list with React Native! </Text> 
			<Text style = {
				{ color: 'white' }
			} > by Wing Kei Leung </Text> 
			</View > 
			</Image> 
			</View >
			)
